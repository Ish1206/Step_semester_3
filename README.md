...
- Organized the programs using the required package structure.
- Created and worked on the feature/session_1 branch.

**Next Session Plan:**
- Continue with the next STEP session and complete the assigned programming problems.
